...
final class EngineTests: XCTestCase {
    ...
    func assertInput(_ input: String, produces expected: String, method: UkInputMethod = .telex, file: StaticString = #file, line: UInt = #line) {
        // Setup input method
        ...
        XCTAssertEqual(currentText, expected, "Input '\(input)' should produce '\(expected)'", file: file, line: line)
    }
